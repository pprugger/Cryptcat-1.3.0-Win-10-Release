...
//
  ...
  //Changed the behaviour when no arguments are given, now the help will be shown, when HAVE_HELP is defined
  //to change the behaviour to the original state just uncomment the code on top of this block.
  if (argc == 1)
  {
	  errno = 0;
#ifdef HAVE_HELP
